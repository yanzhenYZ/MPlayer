...
//yanzhen_2020-09-04
static NSString *const YZPlayerStatusDidChangeNotification  = @"YZPlayerStatusDidChangeNotification";
...
@property (nonatomic) BOOL activeResume;

- (void)didShutdown;

#pragma mark KVO properties
@property (nonatomic, readonly) IJKFFMonitor *monitor;
@property (nonatomic, readonly) struct IjkMediaPlayer *mediaPlayer;
